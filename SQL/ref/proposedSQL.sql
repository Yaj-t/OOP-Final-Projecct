...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1256784973ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=bookings">`roomease`.`bookings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=users">`roomease`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=payments">`roomease`.`payments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=rooms">`roomease`.`rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms_db&table=rooms">`rms_db`.`rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=room_amenities">`roomease`.`room_amenities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=tenants">`roomease`.`tenants`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms_db&table=check_ins">`rms_db`.`check_ins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms_db&table=check_outs">`rms_db`.`check_outs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms_db&table=employee_action_log">`rms_db`.`employee_action_log`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE Complaint (
