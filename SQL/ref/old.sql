...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1892624315ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=employee_login_log">`roomease`.`employee_login_log`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=employee_action_log">`roomease`.`employee_action_log`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=users">`roomease`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=admin_login_log">`roomease`.`admin_login_log`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=admin_action_log">`roomease`.`admin_action_log`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=tenant">`roomease`.`tenant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=room">`roomease`.`room`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=rentals">`roomease`.`rentals`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=payments">`roomease`.`payments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=roomease&table=complaint">`roomease`.`complaint`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="734d4752497472392322613f6c28684c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="roomease" targettable="admin_login_log">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_login_log`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="complaint">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `complaint`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="employee_action_log">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `employee_action_log`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="employee_login_log">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `employee_login_log`</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `payments`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="rentals">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rentals`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="room">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `room`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="tenant">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tenant`</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO users (user_type, username, password, name)
VALUES (&#039;ADMIN&#039;, &#039;admin&#039;, &#039;admin123&#039;, &#039;Admin User&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_login_log`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="admin_action_log">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_action_log`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="roomease" targettable="admin_action_log">
                            <div class="action_content">
